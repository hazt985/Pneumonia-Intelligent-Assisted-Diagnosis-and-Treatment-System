    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['demo:knowledge:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['demo:knowledge:export']"
        >
      ...
      <el-table-column label="操作" align="center">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['demo:knowledge:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['demo:knowledge:delete']"
          >
            删除
          </el-button>
        </template>
...
import { KnowledgeApi, KnowledgeVO } from '@/api/demo/knowledge'
